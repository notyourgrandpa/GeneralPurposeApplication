...
namespace GeneralPurposeApplication.Server.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(ApplicationDbContext context, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IWebHostEnvironment env, IConfiguration configuration, ISeedService seedService)
        {
            _context = context;
